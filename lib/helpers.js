...
helpers.interpolate = (str, data) => {
  ...
  // Add the templateGlobals to the data object, prependind their key name with "global"
  ...
  // For each key in the data object, insert its value into the string at the corresponding place older
  for (var key in data) {
