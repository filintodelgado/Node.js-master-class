...
handlers.index = (data, callback) => {
  ...
  if (data.method == 'get') {
    ...
    var templateData = {
      ...
      'head.discription' : 'We offer simple uptime monitoring for HTTP/HTTPS sites of all kinds.\nWhen your site goes down we\'ll send you a text to let you know',
      'body.class' : 'index'
    }
...
handlers.accountCreate = (data, callback) => {
  ...
  if (data.method == 'get') {
    ...
    var templateData = {
      ...
      'head.discription' : 'Sign up is easy and only takes a few seconds',
...
handlers.sessionCreate = (data, callback) => {
  ...
  if (data.method == 'get') {
    ...
    var templateData = {
      ...
      'head.discription' : 'Please enter your phone number and password',
...
handlers.sessionDeleted = (data, callback) => {
  ...
  if (data.method == 'get') {
    ...
    var templateData = {
      ...
      'head.discription' : 'You have been logged out of your account',
...
handlers.favicon = (data, callback) => {
  // Reject any data that isn't GET
  if (data.method == 'get') {
...
handlers.public = (data, callback) => {
  // Reject any request thta isn't GET
  if (data.method == 'get') {
